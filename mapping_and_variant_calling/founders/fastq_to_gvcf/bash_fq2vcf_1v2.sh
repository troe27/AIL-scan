...
## bash script to create g.vcfs from paired fastq input
## using BWA, samtools, picard and GATK HaplotypeCaller
## this script takes a forward reads fastq ({sample}_R1_001.fastq.gz) as input at position {1}
## use akin to this: " cat list_with_forward_files.txt | xargs -n1 -I{} sbatch this_script.sh {} "
...
#SBATCH -p core -n 4
#SBATCH -t 100:00:00
#SBATCH -J 008_full_new
#SBATCH --mail-type=all
#SBATCH --get-user-env
#SBATCH --mail-user=tillman.ronneburg@imbim.uu.se
#SBATCH -o /home/tilman/storage/subset3/008_full_new_%j.out
#SBATCH -e /home/tilman/storage/subset3/008_full_new_%j.error
