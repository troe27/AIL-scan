...
save.image('20210113_Wahlberg_markers_afterRF.Rdata')

genmap <- est.map(datf2.4, error.prob=0.005)

save.image('20210113_Wahlberg_markers_aftergenmap.Rdata')
...
save.image(file = "20210113_rqtl_all_individs_wahlberg_markers.Rdata")