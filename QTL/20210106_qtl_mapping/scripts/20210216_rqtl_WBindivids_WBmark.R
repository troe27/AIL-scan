...
save.image('20210216_WBindivid_WBmark_afterRF.Rdata')
...
save.image('20210216_WBindivid_WBmark_aftergenmap.Rdata')
...
save.image(file = "20210216_rqtl_WBindivids_WBmarkers.Rdata")