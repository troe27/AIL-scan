...
f2cross <- read.cross(format="csv",dir="/Users/orjanc/Dropbox/Projects/Ongoing/HL_F2_SeqMrk/F2_re_seq/data/",file = "F2_827.typeII.10.gg6.130406.csv",na.strings = "NA",genotypes = c("A", "H", "B", "C", "D"), estimate.map = FALSE, map.function = "haldane", sep = ";")
