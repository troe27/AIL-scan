...
S2 <- read.table("../../../auxillary_data/old_qtls/YZ2017_supp2.txt", header = 1)


liftdata <- S2[!is.na(S2[,2]),c(1,2,3)] #chr, bp-pos and name of all markers that do not have missing position
...
write.csv(tmp3, '../../../auxillary_data/old_qtls/YZ2017_supp2_GG6.txt')
